/*
    ...
    Here's some guidance for how selection sort should work:
        ...
        (similar to how after the first iteration of bubble sort, we know the rightmost element is in its correct place).
...
function selectionSort(arr, comparator) {
	...
	for (let i = 0; i < arr.length; i++) {
		...
		for (let j = i + 1; j < arr.length; j++)
			if (comparator(arr[smallestValueIndex], arr[j]) > 0) smallestValueIndex = j;
